...
class INat2017(VisionDataset):
    ...
    def __init__(self, root, split='train', resize=500, transform=None, target_transform=None, download=False):
        super(INat2017, self).__init__(root, transform=transform, target_transform=target_transform)
        self.loader = default_loader
        self.split = verify_str_arg(split, "split", ("train", "val",))
        self.resize = resize
        self.transform = get_transform(self.resize, split)
        self.num_classes = 5089
